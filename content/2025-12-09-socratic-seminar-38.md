+++
title = "NashBitDevs Socratic Seminar #38"
template = "post.html"
[extra]
meetup_id = "307443117"
+++
...
- Blocks found
  - [Gamma](https://mempool.space/block/00000000000000000001457a4acc5da8e886dddd0a79a6899957a502e0a1977b)
  - [The Space](https://mempool.space/block/0000000000000000000027890c7e717f3004fd5f34f4f7795552a145a227fe72)
- [Quantum futures @Rob1Ham](https://github.com/Rob1Ham/quantum_futures)

#### Demos

- [SatsBuddy](https://github.com/reez/SatsBuddy)
...
- new [snap-bitcoin-wallet](https://github.com/MetaMask/snap-bitcoin-wallet) for MetaMask mobile and browser ext based on [bdk-wasm](https://github.com/bitcoindevkit/bdk-wasm)
- [BDK Release wallet-2.3.0](https://github.com/bitcoindevkit/bdk_wallet/releases/tag/wallet-2.3.0)
...
- [Mutation test consensus_encoding rust-bitcoin#5240](https://github.com/rust-bitcoin/rust-bitcoin/pull/5240)
- [chore(script): implement is_p2a for ScriptPubKeyExt rust-bitcoin#5199](https://github.com/rust-bitcoin/rust-bitcoin/pull/5199)
...
- Bittr self custodial lightning app
  - [GitHub](https://github.com/getbittr/bittr-ios-app)
  - [Announcement](https://x.com/GetBittr/status/1994319347989328138)
- moneydevkit
